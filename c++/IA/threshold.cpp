...
int main(void)
{
  int n=5; //la longitud del vector de entrada incluye la bias
  double theta = 0.5; //threhold
  //Asignacion de memoria para el vector de peso w
  double* w = new double[n];
  w[0] = -theta;
  w[1] = 0.7; w[2] = -1.1; w[3] = 4.5; w[4] = 1.5;

  //Asignacion de memoria para el vector de entrada x
